...
"[project]/molt/steppe-visualization/app/api/deliverables/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].access(DELIVERABLES_PATH);
        } catch  {
...
async function getAllFiles(dir, basePath = '') {
    ...
    try {
        ...
        for (const entry of entries){
            ...
            const relativePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(basePath, entry.name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__923a3b22._.js.map