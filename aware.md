...
2. **Review Architecture Files**
   - `aware.md` - Full detailed architecture (this file)
   - `ARCHITECTURE.md` - Token-optimized summary
   - Check existing patterns, verify no conflicts

3. **Update Both Files**
   - Update ARCHITECTURE.md (token-optimized)
   - Update aware.md (full version)
   - Keep them in sync
