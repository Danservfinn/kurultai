...
class ModelSwitcher:
    ...
    def __init__(
        ...
        moltbot_default = os.environ.get("MOLTBOT_CONFIG", "/data/.clawdbot/moltbot.json")
        openclaw_default = os.environ.get("OPENCLAW_CONFIG", "/data/.clawdbot/openclaw.json")
        history_default = os.environ.get("MODEL_SWITCH_HISTORY", "/data/.clawdbot/.model-switch-history.json")
    ...
    def _log_switch(self, changes: list, reason: Optional[str]):
        ...
        log_path = Path(os.environ.get("MODEL_SWITCH_LOG", "/data/.clawdbot/model-switch.log"))
