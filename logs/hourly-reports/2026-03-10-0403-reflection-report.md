# Hourly Kurultai Reflection Report -- 2026-03-10 04:03

**Model:** unknown

**Pipeline duration:** 211s
**Steps:** anomaly-scanner(0s), rule-compliance(1s), task-metrics(0s), voting-phase1-proposals(0s), voting-phase2-start(0s), voting-phase3-consensus(1s), reflection-research-persist(0s), session-drift-detect(0s), voting-phase4-tasks(0s), capability-scores(1s), cross-agent-rules(0s), memory-audit-fix(0s), routing-audit(1s), action-scorer(0s), score-skills(0s), kublai-actions(0s), kublai-initiative(0s), kurultai-report(5s), report-analysis(0s), update-skill-stats(0s), hourly-report(0s)
